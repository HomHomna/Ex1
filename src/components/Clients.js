export default function Clients(){
  ...
  return(
    <div className="w-full bg-blue-700" id="client">
      <div className="text-center text-white pt-11">
        <h2 className="underline decoration-4 underline-offset-8 decoration-black  text-lg	font-bold">Clients</h2>
        <div className="mt-6">Check out some of my previous clients</div>
      </div>
      <div className="flex gap-14 justify-center	mt-8 pb-11">
        <img src={imgUber} alt="Uber" className="w-32 h-12 my-auto" />
        <img src={imgDeli} alt="Deliveroo" className="w-40 h-12 my-auto"/>
        <img src={imgMicro} alt="Microsoft" className="w-44 h-10 my-auto"/>
