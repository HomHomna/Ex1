export default function HeaderPage() {
  ...
  return(
    <div style={{ backgroundImage: `url(${bgimg})` }} className="bg-upset bg-cover bg-no-repeat w-full h-full bg-blue-900 opacity-90">
      ...
      <section className=" ml-32 text-white">
        <div className="text-6xl w-6/12 mt-16 font-bold">
